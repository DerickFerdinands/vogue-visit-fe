...
const Nav = () => {
    return (
        <div className={"flex p-10 gap-5 justify-between flex-wrap items-center"}>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline"
                            ...
                            <h5 className={"font-light"}>Derick Ferdinands</h5>
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className={"w-full"} align="end">
                        ...
                        <DropdownMenuItem>
                            <Link className={"flex gap-3 items-center"} href={"/sign-out"}>
